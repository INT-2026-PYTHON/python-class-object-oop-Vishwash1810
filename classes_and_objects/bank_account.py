...
class BankAccount:
    ...
    def __init__(self, name, account_number, opening_balance=0):
        ...
        if opening_balance < 0:
            print(f"Opening balance cannot be negative. Setting to 0.")
            opening_balance = 0
...
# Valid operations on Alice's account
a1.deposit(200)
a1.withdraw(100)
    
# Invalid operation on Alice's account (overdraft)
a1.withdraw(2000)
    
# Invalid operation on Bob's account (negative deposit)
a2.deposit(-50)
    
# Valid operation on Bob's account
a2.deposit(300)
